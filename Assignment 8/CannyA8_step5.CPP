	...
	void main(void)
	{
	   ...
	   for(i=0; i<IMG_NUM; i++)
	   {
	      ...
	      ****************************************************************************/
          ...
          sc_time.write(t1);
          printf(t1,"Stimulus sent frame %s.\n" ,i);
	   }
	}
...
SC_MODULE(Monitor){
	...
	******************************************************************************/
	...
	void main(void)
	{
       ...
       printf("Monitor received frame", outfilename," with delay ", delay, "%s.\n")
...
{       event x1, x2, data_received;
        ...
        int center;
        FIMAGE tempim;
        void blur_x1(int rows, int cols)
        {
            ...
            wait(855, MS);
            x1.notify(SC_ZERO_TIME);
        }
        void blur_x2(int rows, int cols)
        {
            int r, c, cc;         /* Counter variables. */
            float dot,            /* Dot product summing variable. */
            sum;            /* Sum of the kernel weights variable. */
...
{	    event y1,y2,data_received;
        ...
        void blur_y1(int rows, int cols)
        {
            ...
            ****************************************************************************/
            ...
            wait(910,SC_MS);
            y1.notify(SC_ZERO_TIME);
        }

        void blur_y2(int rows, int cols)
        {
            int r, c, rr;         /* Counter variables. */
            float dot,            /* Dot product summing variable. */
            sum;            /* Sum of the kernel weights variable. */
