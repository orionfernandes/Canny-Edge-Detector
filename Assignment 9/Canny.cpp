	...
	{  clock_t start_time=clock();
	   ...
	   ****************************************************************************/
	   while(1)
	   {
        ...
        printf("Gaussian Kernel runtime =%f ms\n",(double)(end_time-start_time)/CLOCKS_PER_SEC*1000);
        return 0;
	}
	...
	*******************************************************************************/
	...
	{  clock_t start_time=clock();
	   while(1)
	   {
        ...
        clock_t end_time=clock();
        wait(480, SC_MS)
        printf("Derivative_X_Y runtime =%f ms\n",(double)(end_time-start_time)/CLOCKS_PER_SEC*1000);
        return 0;
	}
	...
	*******************************************************************************/
	...
	{   clock_t start_time=clock();
	   while(1)
	   {
        ...
        clock_t end_time=clock();
        wait(1030, SC_MS)
        printf("Magnitude_X_Y runtime =%f ms\n",(double)(end_time-start_time)/CLOCKS_PER_SEC*1000);
        return 0;
	}
	...
	*******************************************************************************/
	...
	{  clock_t start_time=clock();
	   ...
	   while(1)
	   {
        ...
        clock_t end_time=clock();
        wait(830, SC_MS)
        printf("Non_Max_Supp runtime =%f ms\n",(double)(end_time-start_time)/CLOCKS_PER_SEC*1000);
        return 0;
	}
...
SC_MODULE(Apply_Hysteresis)
{
	...
	* all paths whose magnitude values remain above some specifiable lower
	* threshold.
	* NAME: Mike Heath
	* DATE: 2/15/96
	*******************************************************************************/
	...
	*******************************************************************************/
	...
	{  clock_t start_time=clock();
	   while(1)
	   {
        ...
        clock_t end_time=clock();
        wait(670, SC_MS)
        printf("Apply_Hysteresis runtime =%f ms\n",(double)(end_time-start_time)/CLOCKS_PER_SEC*1000);
        return 0;
	}
